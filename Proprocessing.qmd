...
Donnelly_eeg <- readRDS("/Users/thea/Downloads/sleep_study_eeg_summary_data_z.rds")
Donnelly_psdrow <- readRDS("/Users/thea/Downloads/sleep_study_beh_psych_demographic_data.rds")
#> view(Donnelly_eeg)
#> view(Donnelly_psdrow)
...
effect_size <- data.frame()
for (var in variables) {
  effect_var <- circular_cor(Donnellyphase_avg[[var]], Donnelly_psd$retention)
  effect_size <- rbind(effect_size, effect_var)
}
...
cor <- c(
  "Frontal" = cor(Donnelly_psd$retention ~ Donnellyamp_avg$Favg, use = "complete"),
  "Central" = cor(Donnelly_psd$retention ~ Donnellyamp_avg$Cavg, use = "complete"),
  "Parietal" = cor(Donnelly_psd$retention ~ Donnellyamp_avg$POavg, use = "complete"))
...
cor <- c(
  "Frontal" = cor(Donnelly_psd$retention ~ Donnellystr_avg$Favg, use = "complete"),
  "Central" = cor(Donnelly_psd$retention ~ Donnellystr_avg$Cavg, use = "complete"),
  "Parietal" = cor(Donnelly_psd$retention ~ Donnellystr_avg$POavg, use = "complete"))
