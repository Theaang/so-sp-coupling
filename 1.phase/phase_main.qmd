...
phase_main <- 
  brm(
    esz | se(se) + trunc(lb = -0.5) ~ 1 + (1|studyid/esid),
    data = phase_final,
    family = gaussian(),
...
phase_m3 <- 
  brm(
    esz | se(se) + trunc(lb = 0) ~ 1 + sleepsp_type + (1|studyid/esid),
    data = phase_final,
    family = gaussian(),
    prior = prior_family$prior_phasemod,
    sample_prior = T,
...
phase_m4 <- 
  brm(
    esz | se(se) + trunc(lb = 0) ~ 1 + channel_cl + (1|studyid/esid),
    data = phase_final,
    family = gaussian(),
    prior = prior_family$prior_phasemod,
    iter = iters, 
...
phase_m5 <- 
  brm(
    esz | se(se) + trunc(lb = 0) ~ 1 + sleep_stg + (1|studyid/esid),
    data = phase_final,
    family = gaussian(),
    prior = prior_phasemain,
    sample_prior = T,
...
phase_m6 <- 
  brm(
    esz | se(se) + trunc(lb = 0) ~ 1 + sleep_con + (1|studyid/esid),
    data = phase_final,
    family = gaussian(),
    prior = prior_phasemain,
    sample_prior = T,
